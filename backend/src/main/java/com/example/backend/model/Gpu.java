...
public class Gpu {
    ...
    public Gpu(Integer id, String name, String brand, String partNumber, BigDecimal price, String memory, String coreClock, Integer length, Integer requiredWattage, Integer stock) {
        this.id = id;
        this.name = name;
        this.brand = brand;

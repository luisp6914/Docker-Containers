...
public class PcCase {
    ...
    public PcCase(Integer id, String name, String partNumber, String caseType, String color, BigDecimal price, Integer stock, Integer maxGpuLength, Integer maxCoolerHeight, Integer maxPsuLength) {
        this.id = id;
        this.name = name;

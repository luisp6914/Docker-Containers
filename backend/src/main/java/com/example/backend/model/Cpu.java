...
public class Cpu {
    ...
    public Cpu(Integer id, String name, String brand, String partNumber, BigDecimal price, String coreClock, Integer coreCount, Integer requiredWattage, String socket, Integer stock) {
        this.id = id;
        this.name = name;
        this.brand = brand;
